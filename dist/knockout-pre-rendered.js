...
(function (root, factory) {
    ...
    function initObservable(element, value, allBindings) {
        ...
        //Searching value binding at embedded binding (maskinput:{value:value} or datepicked:{value:date})
        //by "value" name
        if (typeof fieldAccessor === 'undefined') {
            ko.utils.arrayFirst(Object.keys(allBindings()), function (bnd) {
                if (bnd && allBindings.get(bnd) && allBindings.get(bnd)) {
                    fieldAccessor = allBindings.get(bnd).value;
                    return true;
                };
            });
